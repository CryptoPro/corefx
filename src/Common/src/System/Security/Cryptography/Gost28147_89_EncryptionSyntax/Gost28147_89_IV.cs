...
{
   class Gost28147_89_IV : Asn1OctetString {
      public Gost28147_89_IV () : base()
      {
      }
      ...
      public Gost28147_89_IV (byte[] data) : base (data)
      {
      }
      ...
      public Gost28147_89_IV (byte[] data, int offset, int nbytes) :
      ...
      public Gost28147_89_IV (string value) : base (value)
      {
      }
