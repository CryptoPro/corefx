...
{
    class Gost28147_89_Key : Asn1OctetString
    {
        public Gost28147_89_Key() : base()
        {
        }
        ...
        public Gost28147_89_Key(byte[] data) : base(data)
        {
        }
        ...
        public Gost28147_89_Key(byte[] data, int offset, int nbytes) :
        ...
        public Gost28147_89_Key(string value) : base(value)
        {
        }
