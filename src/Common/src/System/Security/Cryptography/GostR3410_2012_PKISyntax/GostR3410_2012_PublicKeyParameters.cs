namespace System.Security.Cryptography
{
   ...
   class GostR3410_2012_PublicKeyParameters : Asn1Type {
      public Asn1ObjectIdentifier publicKeyParamSet;
      public Asn1ObjectIdentifier digestParamSet;
      public Asn1ObjectIdentifier encryptionParamSet;  // optional

      public GostR3410_2012_PublicKeyParameters () : base()
      {
      }
      ...
      public GostR3410_2012_PublicKeyParameters (
         ...
         Asn1ObjectIdentifier encryptionParamSet_
      )
         : base ()
      {
      ...
      /// the given objects 
      /// </summary>
      public GostR3410_2012_PublicKeyParameters (int[] publicKeyParamSet_,
         int[] digestParamSet_,
         ...
         : base ()
      {
         ...
         encryptionParamSet = new Asn1ObjectIdentifier (encryptionParamSet_);
      }
