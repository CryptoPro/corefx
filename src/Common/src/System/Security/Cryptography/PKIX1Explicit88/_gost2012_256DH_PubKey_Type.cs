...
{
   class _gost2012_256DH_PubKey_Type : Asn1Choice {
      // Choice element identifier constants
      public const byte _NULL_ = 1;
      public const byte _PARAMS_ = 2;

      public _gost2012_256DH_PubKey_Type () : base()
      {
      }

      public _gost2012_256DH_PubKey_Type (byte choiceId_, Asn1Type element_) : base()
      {
      ...
      public void Set_params_ (GostR3410_2012_PublicKeyParameters value) {
