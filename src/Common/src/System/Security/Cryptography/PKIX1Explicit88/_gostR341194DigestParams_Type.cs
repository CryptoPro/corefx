...
{
   class _gostR341194DigestParams_Type : Asn1Choice {
      // Choice element identifier constants
      public const byte _NULL_ = 1;
      public const byte _PARAMS_ = 2;

      public _gostR341194DigestParams_Type () : base()
      {
      }
      ...
      public void Set_params_ (GostR3411_94_DigestParameters value) {
         ...
         (Asn1BerDecodeBuffer buffer, bool explicitTagging, int implicitLength)
      {
         ...
         else if (tag.Equals (Asn1Tag.Universal, Asn1Tag.PRIM, 6))
         {
            buffer.Reset();
            GostR3411_94_DigestParameters params_ = new GostR3411_94_DigestParameters();
      ...
      public override int Encode (Asn1BerEncodeBuffer buffer, bool explicitTagging)
      {
         ...
         // encode params_
         case _PARAMS_:
            GostR3411_94_DigestParameters params_ = (GostR3411_94_DigestParameters) GetElement();
