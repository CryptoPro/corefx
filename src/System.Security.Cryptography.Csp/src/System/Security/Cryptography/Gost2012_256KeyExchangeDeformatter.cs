...
namespace CryptoPro.Sharpei
{
    ...
    /// <see cref="Gost2012_256KeyExchangeFormatter"/>.</para>
    /// </remarks>
    /// 
    ...
    [ComVisible(true)]
    public class Gost2012_256KeyExchangeDeformatter : AsymmetricKeyExchangeDeformatter
    {
        /// <summary>
        /// Конструктор объекта класса <see cref="Gost2012_256KeyExchangeDeformatter"/>
        /// </summary>
        public Gost2012_256KeyExchangeDeformatter()
        {
        }
        ...
        /// ключами.</param>
        /// <argnull name="key" />
        public Gost2012_256KeyExchangeDeformatter(AsymmetricAlgorithm key)
        {
            if (key == null)
