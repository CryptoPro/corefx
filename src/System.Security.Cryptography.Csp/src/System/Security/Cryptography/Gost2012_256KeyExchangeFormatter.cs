...
namespace CryptoPro.Sharpei
{
    ...
    /// <see cref="Gost2012_256KeyExchangeDeformatter"/>.</para>
    /// </remarks>
    /// 
    /// <doc-sample path="Simple\Encrypt" name="KeyExchange2012_256">Пример работы с 
    /// форматтером и деформаттером обмена ключами.</doc-sample>
    /// <seealso cref="Gost2012_256KeyExchangeDeformatter"/>
    [ComVisible(true)]
    public class Gost2012_256KeyExchangeFormatter : AsymmetricKeyExchangeFormatter
    {
        /// <summary>
        /// Создание объекта класса <see cref="Gost2012_256KeyExchangeFormatter"/>.
        /// </summary>
        public Gost2012_256KeyExchangeFormatter()
        {
        }

        /// <summary>
        /// Конструктор объекта класса <see cref="Gost2012_256KeyExchangeFormatter"/> 
        ...
        /// <argnull name="key" />
        public Gost2012_256KeyExchangeFormatter(AsymmetricAlgorithm key)
        {
            if (key == null)
                throw new ArgumentNullException("key");
            gostKey_ = (Gost3410_2012_256)key;
        }
        ...
        public GostKeyTransport CreateKeyExchange(SymmetricAlgorithm alg, GostKeyWrapMethod wrapMethod)
        {
            ...
            Gost3410Parameters senderParameters = gostKey_.ExportParameters(false);

            GostKeyTransportObject transport = new GostKeyTransportObject();

            // Создаем эфимерный ключ с параметрами получателя.
            using (Gost3410_2012_256EphemeralCryptoServiceProvider sender = new Gost3410_2012_256EphemeralCryptoServiceProvider(
                senderParameters))
            {
        ...
        /// </summary>
        private Gost3410_2012_256 gostKey_;
    }
