    ...
    public sealed class Gost3410_2012_256EphemeralCryptoServiceProvider : Gost3410_2012_256
    {
        ...
        public Gost3410_2012_256EphemeralCryptoServiceProvider(Gost3410Parameters basedOn)
        {
            ...
            CapiHelper.GenerateKey(_safeProvHandle,
                GostConstants.ALG_SID_DH_GR3410_12_256_EPHEM, CspProviderFlags.NoFlags,
                GostConstants.GOST3410_2012_256KEY_SIZE, basedOn.DigestParamSet,
        ...
        public Gost3410_2012_256EphemeralCryptoServiceProvider()
        {
            _safeKeyHandle = SafeKeyHandle.InvalidHandle;
            CapiHelper.GenerateKey(_safeProvHandle,
                GostConstants.ALG_SID_DH_GR3410_12_256_EPHEM, (CspProviderFlags)0,
                GostConstants.GOST3410_2012_256KEY_SIZE, out _safeKeyHandle);
        }
            ...
            bool includePrivateParameters)
        {
            ...
            CapiHelper.ExportPublicKey(_safeKeyHandle, obj1, CspAlgorithmType.Gost2012_256);
