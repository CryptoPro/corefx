...
namespace System.Security.Cryptography
{
    ...
    /// </summary>
    /// 
    /// <remarks><para> Класс <c>Gost3410_2012_512CryptoServiceProvider</c> 
    ...
    /// 512, и открытый ключ длиной 512 бит.</para>
    /// </remarks>
    /// 
    ...
    /// 
    /// <doc-sample path="Simple\Sign" name="Gost3410_2012_512CSPSample">Пример работы с 
    ...
    /// 
    /// <cspversions />
    public sealed class Gost3410_2012_512CryptoServiceProvider : Gost3410_2012_512, ICspAsymmetricAlgorithm
    {
        /// <summary>
        ...
        private Gost3411_2012_512 _hashImpl;
        ...
        /// <see cref="Gost3410_2012_512CryptoServiceProvider.UseMachineKeyStore"/>
        /// в момент создания объекта.</para>
        /// <para>Создание ключей будет отложено до момента, когда
        /// этот ключ реально потребуется.</para>
        /// </remarks>
        /// 
        /// <doc-sample path="Simple\Sign" name="Gost3410_2012_512CSPSample">Пример создания 
        /// и работы с Gost3410_2012_512CryptoServiceProvider.
        ///  </doc-sample>
        [SecuritySafeCritical]
        public Gost3410_2012_512CryptoServiceProvider()
            : this(
                new CspParameters(
                    GostConstants.PROV_GOST_2012_512,
                    null,
                    null,
                    Gost3410_2012_512CryptoServiceProvider.s_useMachineKeyStore))
        {
        }
        ...
        /// флага из 
        /// <see cref="Gost3410_2012_512CryptoServiceProvider(CspParameters)"/>
        ...
        [SecuritySafeCritical]
        public Gost3410_2012_512CryptoServiceProvider(CspParameters parameters)
        {
            _parameters = CapiHelper.SaveCspParameters(
                CapiHelper.CspAlgorithmType.Gost2012_512,
                parameters,
                s_useMachineKeyStore,
                out _randomKeyContainer);
            _keySpec = _parameters.KeyNumber;
            LegalKeySizesValue = new KeySizes[] { new KeySizes(GostConstants.GOST3410_2012_512KEY_SIZE, GostConstants.GOST3410_2012_512KEY_SIZE, 0) };

            _hashImpl = Gost3411_2012_512.Create();
            if (!_randomKeyContainer) GetKeyPair();
        }

        [SecuritySafeCritical]
        public Gost3410_2012_512CryptoServiceProvider(IntPtr hProvHandle, int keySpec)
        {
            _safeProvHandle = new SafeProvHandle(hProvHandle, true);
            _keySpec = keySpec;

            LegalKeySizesValue = new KeySizes[] { new KeySizes(
                GostConstants.GOST3410_2012_512KEY_SIZE, GostConstants.GOST3410_2012_512KEY_SIZE,  0) };
            _safeKeyHandle = CapiHelper.GetKeyPairHelper(
                            CspAlgorithmType.Gost2012_512,
                            keySpec,
                            GostConstants.GOST3410_2012_512KEY_SIZE,
                            _safeProvHandle);
            _hashImpl = Gost3411_2012_512.Create();
        }
        ...
        protected override byte[] HashData(Stream data, HashAlgorithmName hashAlgorithm)
        {
            ...
            using (HashAlgorithm hash = Gost3411_2012_512.Create())
            {
        ...
        {
            if (hashAlgName != HashAlgorithmName.Gost3411_2012_512)
            {
        ...
        public override byte[] SignHash(byte[] rgbHash)
        {
            ...
            if (rgbHash.Length != (GostConstants.GOST3411_2012_512_SIZE / 8))
            {
                throw new CryptographicException(
                    string.Format(
                        SR.Cryptography_InvalidHashSize,
                        "GOST3411_2012_512", GostConstants.GOST3411_2012_512_SIZE / 8));
            }
            GetKeyPair();
            return CapiHelper.SignValue(
                ...
                GostConstants.CALG_GR3411_2012_512,
                rgbHash);
        }
        ...
        /// <param name="hashAlgName">Алгоритм ГОСТ 34.11-2012 512</param>
        /// <returns><see langword="true"/>, если подпись подлинна, 
        /// <see langword="false"/> - иначе.</returns>
        /// 
        /// <remarks>Алгоритм вычисления хэш для ГОСТ Р 34.10-2012 512
        /// всегда ГОСТ Р 34.11-2012 512.</remarks>
        /// 
        /// <doc-sample path="Simple\Sign" name="SignHash">Пример подписи и 
        ///  проверки подписи хэш.</doc-sample>
        ///  
        ...
        /// алгоритма ГОСТ Р 34.10-2012 512 без параметров. </param>.
        /// 
        ...
        public override Gost3410Parameters ExportParameters(bool includePrivateParameters)
        {
            ...
            AsnHelper.DecodePublicBlob(obj1, data, CspAlgorithmType.Gost2012_512);
        ...
        public override int KeySize
        {
            ...
            get
            {
                ...
                return GostConstants.GOST3410_2012_512KEY_SIZE;
            }
        }
        ...
        /// <see cref="Gost3410_2012_512CryptoServiceProvider"/> экземпляром класса
        ...
        /// <see cref="Gost3410_2012_512CryptoServiceProvider"/> содержит только 
        ...
        //        machine, parent, GostConstants.PROV_GOST_2012_512);
        //}
        ...
        /// BLOB открытого ключа алгоритма ГОСТ Р 34.10-2012 512
        /// </summary>
        /// <param name="keyBlob">Проверяемый BLOB.</param>
        /// <returns><see langword="true"/>, если похоже на BLOB ГОСТ Р 34.10-2012 512
